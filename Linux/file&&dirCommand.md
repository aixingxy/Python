...
- [文件和目录常用命令](#文件和目录常用命令)
	- [终端实用技巧](#终端实用技巧)
		- [在敲出文件/目录/命令的前几个字母之后，按下tab键](#在敲出文件目录命令的前几个字母之后按下tab键)
		- [曾经使用过的命令](#曾经使用过的命令)
	- [ls命令说明](#ls命令说明)
		- [Linux下文件和目录的特点](#linux下文件和目录的特点)
	- [ls常用选项](#ls常用选项)
		- [ls -l](#ls-l)
		- [ls -h和 ls -l的配合](#ls-h和-ls-l的配合)
	- [ls和通配符的使用](#ls和通配符的使用)
	- [切换目录](#切换目录)
		- [cd](#cd)
			- [cd && cd ~ 切换到当前用户的主目录（/home/用户目录)](#cd-cd-切换到当前用户的主目录home用户目录)
			- [cd .	保持在当前目录不变](#cd-保持在当前目录不变)
			- [cd ..	切换到上级目录](#cd-切换到上级目录)
			- [cd -	可以在最近两次工作目录之间切换](#cd-可以在最近两次工作目录之间切换)
	- [相对路径和绝对路径](#相对路径和绝对路径)
	- [创建和删除操作](#创建和删除操作)
		- [touch](#touch)
		- [mkdir 创建一个新的目录](#mkdir-创建一个新的目录)
	- [rm 删除文件或目录](#rm-删除文件或目录)
		- [rm 也可以和通配符搭配](#rm-也可以和通配符搭配)
		- [-f 强制删除](#-f-强制删除)
		- [rm -r——可使用与删除文件夹（目录）](#rm-r可使用与删除文件夹目录)
...
![cdhome](image/cdhome.png)

#### cd .	保持在当前目录不变

![cd_stable](image/cd_stable.png)
